...
$__System.register('d', [], function (_export) {
	...
	var COOKIENAME, user, cookies, i, cookie, regexp;
	return {
		setters: [],
		execute: function () {
			COOKIENAME = 'way.user';
...
$__System.register('11', ['10', '12', 'e', 'f'], function (_export) {
	'use strict';

	var html, _, languages, template, _currentLanguage, _currentLanguageText, $el, appendTo, updateLanguageDisplay;
...
$__System.register("15", [], function (_export, _context) {
  ...
  return {
    setters: [],
    execute: function () {
      _export("__useDefault", __useDefault = "<div id=\"logo-wrapper\">\r\n\t<a href=\"./Stories\"><span lang='en'><img id=\"logo\" src=\"../../img/icons/NavBar/WAY_logo.svg\"></span></a>\r\n</div>\r\n<% if(!offline){ %>\r\n\t<nav>\r\n\t\t<div class=\"\" id=\"nav-stories-div\"><a href=\"./Stories\"><button class=\"nav-icon\" id=\"nav-stories-icon\"></button></a></div>\r\n\t\t<!--<div class=\"\"><a href=\"./Games\"><button class=\"nav-icon\" id=\"nav-games-icon\"></button></a></div>-->\r\n\t\t<div class=\"\" id=\"nav-user\">\r\n\t\t\t\r\n\t\t\t<button class=\"nav-icon\" id=\"nav-user-icon\"></button>\r\n\t\t\t<span id=\"nav-user-links\">\r\n\t\t\t\t<% if(user){ %>\r\n\t\t\t\t\t<div><a href=\"./Bookmarks\">\r\n\t\t\t\t\t\t<span lang=\"en\">Bookmarks</span>\r\n\t\t\t\t\t</a></div>\r\n\t\t\t\t\t<div><a href=\"./Logout\">\r\n\t\t\t\t\t\t<span lang=\"en\">Log Out</span>\r\n\t\t\t\t\t</a></div>\r\n\t\t\t\t<% } else { %>\r\n\t\t\t\t\t<div><a href=\"./Login\">\r\n\t\t\t\t\t\t<span lang=\"en\">Log In</span>\r\n\t\t\t\t\t</a></div>\r\n\t\t\t\t<% } %>\r\n\t\t\t</span>\r\n\t\t</div>\r\n\t\t<div class=\"\" id=\"nav-search\">\r\n\t\t\t<form action=\"./Search\">\r\n\t\t\t\t<input id=\"nav-serach-input\" type=\"text\" name=\"search\" />\r\n\t\t\t\t<input id=\"nav-submit-input\" type=\"submit\" value=\"\" />\r\n\t\t\t</form>\r\n\t\t</div>\r\n\t\t<% if(user){ %>\r\n\t\t\t<div class=\"\"><a href=\"./Edit\"><button class=\"nav-icon\" id=\"nav-edit-icon\"></button></a></div>\r\n\t\t<% } %>\r\n\t</nav>\r\n<% } %>");
...
$__System.register('a', ['11', '12', '14', '15', 'b', 'c', 'd'], function (_export) {
	'use strict';

	var LanguageSelector, _, ImageHoverSwap, html, user, template;
...
("*{box-sizing:border-box;font-family:Segoe UI,Arial,Helvetica,sans-serif}::-webkit-scrollbar{width:10px;height:10px}::-webkit-scrollbar-track{box-shadow:inset 0 0 2px 1px #004e74}::-webkit-scrollbar-thumb{box-shadow:inset 0 0 5px 2px #004e74}body,html{margin:0;height:100%;width:100%}footer,header,main{position:fixed;width:100%}header{height:90px;background-color:#fff;top:0;box-shadow:0 4px 7px rgba(0,0,0,.5);z-index:100}main{height:calc(100% - 90px - 25px);overflow:auto;position:fixed;top:90px}footer{height:25px;background-color:#0098ba;bottom:0;box-shadow:0 -1px 2px 0 rgba(0,0,0,.5)}header #language-selector{position:absolute;top:0;right:0}button{border:none}button:hover{cursor:pointer}button:focus{outline:none}[lang]:not(html){display:none}#sectionHead,.bold{font-weight:700}#sectionHead{background-color:#a0eaf7;color:#004e74;text-align:center;font-size:25px;font-family:Segoe UI,Arial,Helvetica,sans-serif;padding-top:10px}#throbber{position:absolute;top:0;left:0;height:100%;width:100%;background-color:hsla(0,0%,100%,.5)}#throbber img{position:absolute;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.half,.quarter,.sixth,.third,.three-quarters,.two-thirds{float:left;width:calc(50% - 20px);margin:9.99px}.third{width:calc(33.33333% - 20px)}.two-thirds{width:calc(66.66667% - 20px)}.quarter{width:calc(25% - 20px)}.three-quarters{width:calc(75% - 20px)}.sixth{width:calc(16.66667% - 20px)}.offline footer{padding:2px 10px;text-align:right;color:#fff}@media (max-height:768px),screen and (max-width:1024px){body{font-size:10pt}header{height:75px}main{height:calc(100% - 75px - 25px);top:75px}}@media screen and (max-width:800px){body,footer,header,main{position:absolute;min-width:800px}}#logo-wrapper{position:absolute;top:0;left:10px;height:100%}#logo{height:100%;vertical-align:middle}#logo a{height:100%;display:block}nav{position:absolute;bottom:0;width:80%;left:20%;padding:3px 15px}nav>div{position:relative;float:right;margin-left:15px;height:48px;width:48px}.nav-icon{display:block;height:100%;width:100%;border:none;background:none;background-repeat:no-repeat;position:absolute;bottom:0;-webkit-backface-visibility:hidden}#nav-stories-icon{background-image:url('../img/icons/NavBar/nav_stories.svg')}nav>div:not(#nav-search):not(.active):hover #nav-stories-icon{background-image:url('../img/icons/NavBar/nav_stories_hoverDown.svg')}#nav-games-icon{background-image:url('../img/icons/NavBar/nav_games.svg')}nav>div:not(#nav-search):not(.active):hover #nav-games-icon{background-image:url('../img/icons/NavBar/nav_games_hoverDown.svg')}#nav-user-icon{background-image:url('../img/icons/NavBar/nav_acct.svg')}#nav-user-icon:focus,nav>div:not(#nav-search):not(.active):hover #nav-user-icon{background-image:url('../img/icons/NavBar/nav_acct_hoverDown.svg')}#nav-edit-icon{background-image:url('../img/icons/NavBar/nav_SB.svg');height:110%}nav>div:not(#nav-search):not(.active):hover #nav-edit-icon{background-image:url('../img/icons/NavBar/nav_SB_hover_selected.svg')}#nav-user-links{position:absolute;width:100px;background-color:#004e74;left:0;padding:5px;display:none;border:3px solid #004e74;border-top:none;top:100%}#nav-user-links div{padding:2px 5px}#nav-user-links a{color:#fff}#nav-user:focus .nav-icon,#nav-user:hover .nav-icon{border-radius:50% 50% 0 0}#nav-user-icon:focus+#nav-user-links,#nav-user:hover #nav-user-links{display:block}#nav-search{width:250px}#nav-search form{height:100%;width:100%}#nav-search #nav-serach-input,#nav-search #nav-submit-input{position:absolute;bottom:0;right:0;height:30px;width:35px}#nav-search #nav-serach-input{width:250px;border:2px solid #0098ba;border-radius:35px;padding:5px 7px;padding-right:41px}#nav-search #nav-submit-input{position:absolute;background-color:#0098ba;background-image:url('../img/icons/search.svg');background-repeat:no-repeat;background-size:60%;background-position:40% 50%;border:none;border-radius:0 50% 50% 0}@media (max-height:768px),screen and (max-width:1024px){nav>div{margin-left:10px;height:30px;width:30px}#nav-stories-div{margin-right:5px}}#language-selector select{background-color:#004e74;color:#fff;height:35px;width:200px;font-size:1.1em;padding:5px;padding-left:40px;text-align:center;border:none;border-bottom-left-radius:15px;-webkit-appearance:none;text-align-last:center;-ms-text-align-last:center;-moz-text-align-last:center}#language-selector select:focus{border-radius:0}#language-selector img{position:absolute;left:10px;top:2px;height:25px}\n/*# sourceMappingURL=__.css.map */");
})
(function(factory) {
