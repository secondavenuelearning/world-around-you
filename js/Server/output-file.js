System.registerDynamic("style/StoryPreview.css!github:systemjs/plugin-css@0.1.37.js", [], false, function ($__require, $__exports, $__module) {
...
System.register("html/Client/StoryPreview.html!github:systemjs/plugin-text@0.0.11.js", [], function (_export, _context) {
  "use strict";
...
System.register('js/Client/StoryPreview.js', ['style/StoryPreview.css!', 'underscore', 'html/Client/StoryPreview.html!text'], function (_export) {
	'use strict';
	...
	return {
		setters: [function (_styleStoryPreviewCss) {}, function (_underscore) {
			_ = _underscore['default'];
		}, function (_htmlClientStoryPreviewHtmlText) {
			html = _htmlClientStoryPreviewHtmlText['default'];
		}],
		execute: function () {
			index = 0;
...
System.registerDynamic("style/Carousel.css!github:systemjs/plugin-css@0.1.37.js", [], false, function ($__require, $__exports, $__module) {
  var _retrieveGlobal = System.registry.get("@@global-helpers").prepareGlobal($__module.id, null, null);
...
System.register("html/Client/Carousel.html!github:systemjs/plugin-text@0.0.11.js", [], function (_export, _context) {
  "use strict";
...
System.register("js/Client/Carousel.js", ["style/Carousel.css!", "underscore", "html/Client/Carousel.html!text", "js/Client/HelperFunctions.js"], function (_export) {
    "use strict";
    ...
    */
    ...
    return {
        setters: [function (_styleCarouselCss) {}, function (_underscore) {
            _ = _underscore["default"];
        }, function (_htmlClientCarouselHtmlText) {
            html = _htmlClientCarouselHtmlText["default"];
        }, function (_jsClientHelperFunctionsJs) {
            ImageHoverSwap = _jsClientHelperFunctionsJs["default"];
        }],
        execute: function () {
...
System.register('js/Client/StoryViewer.js', ['npm:babel-runtime@5.8.38/core-js/object/keys.js', 'underscore', 'js/Client/HelperFunctions.js'], function (_export) {
    var _Object$keys, _, ImageHoverSwap, storyData, pageIndex, totalPages, writtenLang, writtenOptions, signLang, signOptions, textArea, visuals, fullscreen;
...
System.registerDynamic('npm:core-js@1.2.7/library/modules/$.to-object.js', ['./$.defined'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic('npm:core-js@1.2.7/library/modules/$.ctx.js', ['./$.a-function'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic('npm:core-js@1.2.7/library/modules/$.export.js', ['./$.global', './$.core', './$.ctx'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic('npm:core-js@1.2.7/library/modules/$.object-sap.js', ['./$.export', './$.core', './$.fails'], true, function ($__require, exports, module) {
    var global = this || self,
        GLOBAL = global;
    /* */
...
System.registerDynamic('npm:core-js@1.2.7/library/modules/es6.object.keys.js', ['./$.to-object', './$.object-sap'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic('npm:core-js@1.2.7/library/fn/object/keys.js', ['../../modules/es6.object.keys', '../../modules/$.core'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic("style/Filter.css!github:systemjs/plugin-css@0.1.37.js", [], false, function ($__require, $__exports, $__module) {
  var _retrieveGlobal = System.registry.get("@@global-helpers").prepareGlobal($__module.id, null, null);
...
System.registerDynamic('npm:underscore@1.9.1/underscore.js', [], true, function ($__require, exports, module) {
  /* */
  "format cjs";
  //     Underscore.js 1.9.1
...
System.registerDynamic("npm:underscore@1.9.1.js", ["npm:underscore@1.9.1/underscore.js"], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  module.exports = $__require("npm:underscore@1.9.1/underscore.js");
});
System.register('js/Client/HelperFunctions.js', ['underscore'], function (_export) {
    'use strict';
...
System.register('js/Client/Filter.js', ['npm:babel-runtime@5.8.38/core-js/object/keys.js', '../../style/Filter.css!', 'underscore', 'js/Client/HelperFunctions.js'], function (_export) {
    var _Object$keys, _, ImageHoverSwap, filters, filterRegex, finalResults, database;
    ...
    */
    ...
    return {
        setters: [function (_babelRuntimeCoreJsObjectKeys) {
            _Object$keys = _babelRuntimeCoreJsObjectKeys['default'];
        }, function (_styleFilterCss) {}, function (_underscore) {
            _ = _underscore['default'];
        }, function (_jsClientHelperFunctionsJs) {
            ImageHoverSwap = _jsClientHelperFunctionsJs['default'];
        }],
...
System.register('js/Client/viewer.js', ['js/Client/StoryPreview.js', 'js/Client/Carousel.js', 'js/Client/StoryViewer.js', 'js/Client/HelperFunctions.js', 'js/Client/Filter.js'], function (_export) {
    //import 'style/Viewer.css!';
    //import html from 'html/Client/Viewer.html!text';

    'use strict';

    var StoryPreview, Carousel, StoryViewer, ImageHoverSwap, FiltersBar, totalLikes, canLike;
    ...
    return {
        setters: [function (_jsClientStoryPreviewJs) {
            StoryPreview = _jsClientStoryPreviewJs['default'];
        }, function (_jsClientCarouselJs) {
            Carousel = _jsClientCarouselJs['default'];
        }, function (_jsClientStoryViewerJs) {
            StoryViewer = _jsClientStoryViewerJs['default'];
        }, function (_jsClientHelperFunctionsJs) {
            ImageHoverSwap = _jsClientHelperFunctionsJs['default'];
        }, function (_jsClientFilterJs) {
            FiltersBar = _jsClientFilterJs['default'];
        }],
        execute: function () {
            canLike = true;
