...
<package xmlns="http://www.idpf.org/2007/opf"
    ...
    <metadata xmlns:dc="http://purl.org/dc/elements/1.1/"
        ...
        <dc:contributor id="signer"><%= signer %></dc:contributor>
        <meta property="role" refines="#signer">sign</meta>
        <dc:contributor id="translator"><%= translator %></dc:contributor>
        <meta property="role" refines="#translator">tran</meta>
    ...
    <manifest>
        ...
        <item id="video_<%= index %>" href="images/<%= video.id %>.<%= video.extension %>" media-type="<%= video.mediaType %>" />
        <% }) %>
