...
$__System.register("29", [], function (_export, _context) {
  ...
  return {
    setters: [],
    execute: function () {
      _export("__useDefault", __useDefault = "<div id=\"<%- id %>\" class=\"custom-select\">\r\n\t<button class=\"custom-select-value\"><%- defaultText %></button>\r\n\t<div class=\"custom-select-options\">\r\n\t\t<% _.each(options, function(option){ %>\r\n\t\t\t<div>\r\n\t\t\t\t<% if(multiSelect){  %>\r\n\t\t\t\t\t<input type=\"checkbox\" value=\"<%- option %>\"><label><%- option %></label>\r\n\t\t\t\t<% } else { %>\r\n\t\t\t\t\t<button value=\"<%- option %>\"><%- option %></button>\r\n\t\t\t\t<% } %>\r\n\t\t\t</div>\r\n\t\t<% }) %>\r\n\t</div>\r\n</div>");
